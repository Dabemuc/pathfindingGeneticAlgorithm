...
public class MutationsWslkt0_025 extends Kaestchen{
	...
	int wayLength = 200;
	double mutWslkeit = 0.025;				
	double kreuzungsStaerke = 0.99;			
	...
	public static void main(String[] args) {
		new MutationsWslkt0_025();
	}
	
	public MutationsWslkt0_025() {
